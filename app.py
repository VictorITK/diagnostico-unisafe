...
# CONFIGURAÇÃO PARA RODAR NO SERVIDOR (RENDER) SEM PRECISAR DE PASTAS
...
def enviar():
    ...
    pdf.cell(200, 10, f"Pontuacao Total de Risco: {total} / 120", ln=True)
    
    pdf.ln(10)
    pdf.set_font("Arial", 'I', 9)
    nota = "Nota: As questoes foram adaptadas para o vocabulario operacional visando reduzir o vies de interpretacao, mantendo a correlacao direta com os indicadores de 'Mudanca' do padrao HSE e ISO 45003."
